...
dependencies {
    // Default
    implementation 'net.dzikoysk:cdn:1.13.13'
    // Kotlin wrapper
    implementation 'net.dzikoysk:cdn-kt:1.13.13'
}
```
